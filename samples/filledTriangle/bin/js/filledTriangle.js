...
var FilledTriangle = function(buffer,context) {
	odd_Scene.call(this,buffer,context);
};
FilledTriangle.__name__ = true;
FilledTriangle.__super__ = odd_Scene;
FilledTriangle.prototype = $extend(odd_Scene.prototype,{
	create: function() {
