...
class OddVec3Test extends TestCase
{
    ...
    */
    ...
    {
        var v1 = OddVec3.fromArray([1, 2, 3, 4]);
        var v2 = OddVec3.fromArray([]);
    ...
    {
        var v : OddVec3 = OddVec3.fromArray([ -0.5, 2, 0]);
    ...
    {
        var v : OddVec3 = OddVec3.fromArray([-1, 2.5, 1]);
    ...
    {
        var v1 : OddVec3 = OddVec3.fromArray([0, 2, 1]);
        var v2 : OddVec3 = OddVec3.fromArray([ -1, 1, -1]);
    ...
    {
        var v : OddVec3 = OddVec3.fromArray([0, 2.5, 1]);
    ...
    {
        var v : OddVec3 = OddVec3.fromArray([0, 5, -5]);
        var m : OddMat4 = OddMat4.translate( -10, 5, 0);
    ...
    {
        var v1 : OddVec3 = OddVec3.fromArray([0, -2, 1]);
        var v2 : OddVec3 = OddVec3.fromArray([10, -0.5, 1]);
    ...
    {
        var v1 : OddVec3 = OddVec3.fromArray([2, 2, 2]);
        var v2 : OddVec3 = OddVec3.fromArray([-2, -2, -2]);
    ...
    {
        var v : OddVec3 = OddVec3.fromArray([1, 0, 0]);
