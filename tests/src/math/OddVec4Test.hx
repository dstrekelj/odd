...
class OddVec4Test extends TestCase
{
    ...
    {
        var v1 : Vec4 = Vec4.fromArray([ -2, 0.4, 20, 1, 5.5]);
        var v2 : Vec4 = Vec4.fromArray([]);
    ...
    {
        var v1 : Vec4 = Vec4.fromArray([ -2, 0, 20, 1, 5.5]);
        var v2 : Vec4 = Vec4.fromArray([]);
    ...
    {
        var v : Vec4 = Vec4.fromArray([ -0.5, 2, 0, 1]);
    ...
    {
        var v : Vec4 = Vec4.fromArray([-1, 2.5, 1, 2]);
    ...
    {
        var v : Vec4 = Vec4.fromArray([ -1, -2.5, 1, 2.5]);
    ...
    {
        var v1 : Vec4 = Vec4.fromArray([0, 2, 1, 0]);
        var v2 : Vec4 = Vec4.fromArray([ -1, 1, -1, 5]);
    ...
    {
        var v : Vec4 = Vec4.fromArray([0, 2.5, 1, 5]);
    ...
    {
        var v1 : Vec4 = Vec4.fromArray([0, -2, 1, 5]);
        var v2 : Vec4 = Vec4.fromArray([10, -0.5, 1, 2]);
    ...
    {
        var v : Vec4 = Vec4.fromArray([1, 0, 0, 0]);
